...
public class BookServlet extends BaseServlet {
    ...
    * */
    ...
    protected void add(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        //3 跳到图书页面列表    /manager/bookServlet?action=list
//        req.getRequestDispatcher("/manager/bookServlet?action=list").forward(req,resp);转发
    ...
    protected void delete(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        //2 调用bookServlet.deletedById()删除图书
    ...
    protected void update(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        //3 重定向回 图书列表管理页面       地址:/工程名/manager/bookService?action=list
        resp.sendRedirect(req.getContextPath()+"/manager/bookServlet?action=page&pageNo="+req.getParameter("pageNo"));
    }
